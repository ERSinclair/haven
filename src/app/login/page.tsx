      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-teal-700 text-lg" style={{ fontFamily: 'var(--font-fredoka)' }}>Sign In</span>
          </div>
          <div className="w-12"></div>
        </div>

        {/* Welcome Banner */}
        <div className="bg-teal-100 border border-teal-200 rounded-xl p-4 mb-6">
          <div className="flex items-center gap-3">
            <span className="text-2xl">👋</span>
            <div>
              <p className="font-medium text-teal-800">Welcome back!</p>
              <p className="text-sm text-teal-700">Sign in to your existing Haven account</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Sign in to Haven</h2>
          <p className="text-gray-600 mb-6">Access your profile and connect with families.</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 bg-teal-600 text-white font-semibold rounded-xl hover:bg-teal-700 disabled:bg-gray-200 disabled:text-gray-400 transition-colors"
            >
        ...
        {/* Footer - New User Call to Action */}
        <div className="bg-teal-100 border border-teal-200 rounded-xl p-4 mt-6 text-center">
          <p className="text-teal-800 font-medium mb-2">🌟 New to Haven?</p>
          <p className="text-sm text-teal-700 mb-3">Join families connecting locally</p>
          <Link 
            href="/signup" 
